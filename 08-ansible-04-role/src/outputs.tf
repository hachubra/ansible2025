output "VM_names_and_IPs" {
  ...
  value = [
    ...
    { VM3 = ["instance_name: ${yandex_compute_instance.platform-light.name}","fqdn: ${yandex_compute_instance.platform-light.fqdn}","extenal_ip: ${yandex_compute_instance.platform-light.network_interface[0].nat_ip_address}"]},
   ]
}
