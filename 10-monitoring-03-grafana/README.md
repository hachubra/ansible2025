...
```JSON
{
  ...
  "panels": [
    {
      ...
      "targets": [
        {
          "expr": "100 - ((avg_over_time(node_filesystem_avail_bytes{instance=\"nodeexporter:9100\",job=\"nodeexporter\",mountpoint=\"/\",fstype!=\"rootfs\"}[10s]) * 100) / avg_over_time(node_filesystem_size_bytes{instance=\"nodeexporter:9100\",job=\"nodeexporter\",mountpoint=\"/\",fstype!=\"rootfs\"}[10s]))",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "100 - ((avg_over_time(node_memory_MemAvailable_bytes{instance=\"nodeexporter:9100\",job=\"nodeexporter\"}[10s]) * 100) / avg_over_time(node_memory_MemTotal_bytes{instance=\"nodeexporter:9100\",job=\"nodeexporter\"}[10s]))",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "node_load1{job=\"nodeexporter\", instance=\"nodeexporter:9100\"}\n",
          "interval": "",
          "legendFormat": "CPULA1",
          "refId": "A"
        },
        {
          "expr": "node_load5{job=\"nodeexporter\", instance=\"nodeexporter:9100\"}\n",
          "hide": false,
          "interval": "",
          "legendFormat": "CPULA5",
          "refId": "B"
        ...
        {
          "expr": "node_load15{job=\"nodeexporter\", instance=\"nodeexporter:9100\"}",
          "hide": false,
          "interval": "",
  ...
  "timepicker": {},
  "timezone": "",
  "title": "Nodeexporter utilization",
  "uid": "Rt4qLILHz",
  "version": 8
}
```
